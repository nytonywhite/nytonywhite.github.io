		...
		*/
		__proto.load=function(url){
			...
			if (!ad){
				...
				ad.src = localBase64Loader.chenckResource(url);
				// ad.src=url;
			}
		...
		__proto.play=function(startTime,loops){
			...
			if (Render.isConchApp){
				...
				if (this.url==SoundManager._tMusic){
					...
					tAd.src=localBase64Loader.chenckResource(this.url);
					// tAd.src=this.url;
					}else{
	...
	var WebAudioSound=(function(_super){
		...
		*/
		__proto.load=function(url){
			...
			me.data = localBase64Loader.getResourceToByteArray(url).buffer;
		...
		*/
		...
		WebAudioSound.decode=function(){
			...
			if(!WebAudioSound.tInfo["buffer"]) WebAudioSound.tInfo["buffer"] = localBase64Loader.base64DataToByteArray(WebAudioSound.tInfo["url"]);
	...
	var HttpRequest=(function(_super){
		...
		*/
		__proto.send=function(url,data,method,responseType,headers){
			...
			localBase64Loader.chenckResource(url,function(response){
				_this._http.responseText = JSON.stringify(response);
		...
		__proto.complete=function(data){
			...
			try {
				if (this._responseType==="json"){
					this._data=data||JSON.parse(this._http.responseText);
	...
	var Loader=(function(_super){
		...
		*/
		__proto._loadImage=function(url){
			...
			if (this._type==="nativeimage"){
				...
				localBase64Loader.chenckResource(url,function(response){
					new HTMLImage.create(response,{onload:onload,onerror:onerror,onCreate:function (img){
						image=img;
		...
		*/
		...
		Loader.cacheRes=function(url,data){
			if(url.indexOf('bgm')>=0){ 
				// debugger;
				// url=URL.formatURL(url);
				// data.url = localBase64Loader.chenckResource(url);
			}
			url=URL.formatURL(url);
	...
	var LoaderManager=(function(_super){
		...
		*/
		...
		__proto._endLoad=function(resInfo,content){
			...
			content = content || localBase64Loader.chenckResource(url) || localBase64Loader.chenckResource(baseUrl+'/'+url);

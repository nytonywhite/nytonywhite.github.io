...
function init() {
    ...
    renderer.setSize( myContainerHeight, window.innerHeight );
...
function initLPFrame(){
    ...
    document.body.style.fontSize = screenRate+'px';
    var myContainer = document.getElementById('myContainer');
    var myContainerHeight = myContainer.clientHeight;
...
dlbtn.addEventListener("touchend", function(){window.open(downloadUrl);}, true);

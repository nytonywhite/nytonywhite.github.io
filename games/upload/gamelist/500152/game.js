...
(function(e) {
    ...
    var g = {
        ...
        f = {
            ...
            init: function(e) { t("Initializing :)", e), c = e, o("GAME_INIT", JSON.stringify({ icons: a(), game: c })) },
            ...
            play: function() { t("Function play called.", s), o("GAME_PLAY"), s["ad-play"] && f.mute() && o("AD_SHOW") },
            links: {
                active: function() {
                    return o("GAME_LINKS"), s["links-active"]
                }
            }
        };
    e.CloudAPI = f
